        ...
        <div className='flexCenter w-full sm:w-1/2'>
          <form onSubmit={onSubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-md m-auto gap-y-5 text-gray-800'>
            ...
            <div className='w-full'>
              ...
              <input onChange={(e) => setEmail(e.target.value)} value={email} type="email" placeholder='Enter your email (admin@gmail.com)' 
            ...
            <div className='w-full'>
              ...
              <input onChange={(e) => setPassword(e.target.value)} value={password} type="password" placeholder='Enter your password (admin1234)' 
              className='w-full px-3 py-1.5 ring-1 ring-slate-900/10 rounded bg-primary mt-1'/>
            </div>
