   ...
   <section className='max-padd-container py-16'>
    ...
    <div className='flex flex-col md:flex-row gap-5 gap-y-10'>
      ...
      <div className='flex-1 flexCenter flex-col'>
        <Title title1={'People'} title2={'Says'} titleStyles={'!pb-2'} title1Styles={'h1'} />
        ...
        <p className='max-w-[222px] mt-5 text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur, deleniti dolorem</p>
      </div>
      {/* BANNER */}
      <div className='flex-[2] flex rounded-2xl relative'>
        ...
        <div className='absolute h-full w-full bg-white/20 top-0 left-0'>
          <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/80 p-6 rounded-2xl'>
      ...
      {/* about */}
      <div className='flex-[1] flexCenter flex-col'>
        <Title title1={'About'} title2={'Us'} titleStyles={'!pb-2'} title1Styles={'h3'}/>
        <div className='flex flex-col items-start'>
          <div className='flexCenter gap-3 mb-3'>
            <RiSecurePaymentLine className='text-xl'/>
            <div>
              <h5 className='h5'>Faset & Secure</h5>
