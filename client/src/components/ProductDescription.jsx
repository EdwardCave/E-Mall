    ...
    <div className='ring-1 ring-slate-900/10 rounded-lg'>
        ...
        <div className='flex flex-col gap-3 p-3'>
            <div>
                ...
                <p className='text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae dicta adipisci nihil deserunt delectus? Dignissimos, 
                    numquam eum, voluptates reiciendis ipsa maxime enim quasi praesentium est totam neque dolores quam</p>
