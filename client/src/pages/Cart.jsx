        ...
        <div className='bg-primary mb-16'>
            <div className='max-padd-container py-10'>
                <div className='flexStart gap-x-4'>
                    ...
                    <h5 className='medium-15 text-gray-30 relative bottom-1.5'>({getCartCount()} Itmes)</h5>
                </div>
                        ...
                        return (
                            ...
                            <div className='flex items-center gap-x-3'>
                                <div className='flex items-start gap-6'>
                                    <img src={productData.image[0]} alt="" className='w-20 sm:w-18 rounded' />
                                </div>
                                <div className='flex flex-col w-full'>
                                    ...
                                    <div className='flexBetween'>
                                        <div className='flex items-center ring-1 ring-slate-900/5 rounded-full overflow-hidden bg-primary'>
                                            <button onClick={() => decrement(item._id,item.color)} className='p-1.5 bg-white text-secondary rounded shadow-md'>
                                                <FaMinus className='text-xs'/>
                                            </button>
                                            <p className='px-2'>{quantities[key]}</p>
                                            <button onClick={() => increment(item._id,item.color)} className='p-1.5 bg-white text-secondary rounded shadow-md'>
