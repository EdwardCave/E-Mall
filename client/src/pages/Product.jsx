            ...
            <div className='flex gap-10 flex-col xl:flex-row rounded-2xl p-3 mb-6'>
                ...
                <div className='flex flex-1 gap-x-2 max-w-[477px]'>
                    <div className='flex-1 flex-col flexCenter flex-wrap gap-[7px]'>
                        {product.image.map((item,index) => (
                            <img key={index} onClick={() => setImage(item)} src={item} alt="" className='object-cover aspect-square rounded-lg'/>
                        ))}
                    </div>
                ...
                <div className='flex-[1.5] rounded-2xl px-5 py-3 bg-primary '>
                    ...
                    <div className='flex items-center gap-x-4'>
                        <button onClick={() => addToCart(product._id,color)} className='btn-secondary !rounded-lg sm:w-1/2 flexCenter gap-x-2 capitalize'>Add to cart<TbShoppingBagPlus/></button>
